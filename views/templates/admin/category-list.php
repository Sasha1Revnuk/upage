...
<?php require_once 'header.php';?>
        ...
        ?>
            ...
            for ($i = 0; $i < count($categories); $i++) {
                ...
                echo '<td><a class="btn btn-info" href="/admin/category/edit/' . $categories[$i]['id'] . '"><i class="fa fa-edit "></i></a>  <a class="btn btn-danger" href="/admin/category-list/delete/' . $categories[$i]['id'] . '"><i class="fa fa-trash-o "></i></a></td>'; 
