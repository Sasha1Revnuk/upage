		...
		<div class="container-fluid">		
	        ...
	        <ul class="nav navbar-nav navbar-right">
				<li class="dropdown visible-md visible-lg">
	        		<a href="#" class="dropdown-toggle" data-toggle="dropdown">raphael@mail.com</a>
				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">
						<ul class="nav nav-sidebar">
							<li><a href="index.html"><i class="fa fa-laptop"></i><span class="text"> Main</span></a></li>
							<li>
								<a href="#"><i class="fa fa-file-text"></i><span class="text">Categories</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="category-list.html"><i class="fa fa-list"></i><span class="text">List</span></a></li>
									<li><a href="category-add.html"><i class="fa fa-plus-square-o"></i><span class="text">Add new category</span></a></li>
									<li><a href="link-add.html"><i class="fa fa-tags"></i><span class="text">Add new link</span></a></li>
								</ul>
							</li>
							<li>
								<a href="#"><i class="fa fa-heart-o"></i><span class="text">User settings</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="change-name.html"><i class="fa fa-pencil"></i><span class="text">Change name</span></a></li>
									<li><a href="change-password.html"><i class="fa fa-pencil"></i></i><span class="text">Change password</span></a></li>
								</ul>
							</li>
							<li>
								<a href="#"><i class="fa fa-font"></i><span class="text">Customize</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="change-background.html"><i class="fa fa-list-alt"></i><span class="text">Change background image</span></a></li>
									<li><a href="change-category-text.html"><i class="fa fa-list-alt"></i><span class="text">Change category text color</span></a></li>
									<li><a href="change-main-text-color.html"><i class="fa fa-list-alt"></i><span class="text">Change main text color</span></a></li>
									<li><a href="change-addition-text-color.html"><i class="fa fa-list-alt"></i><span class="text">Change addition text color</span></a></li>
									<li><a href="change-text-background.html"><i class="fa fa-list-alt"></i><span class="text">Change text background</span></a></li>
									<li><a href="change-footer-text-color.html"><i class="fa fa-list-alt"></i><span class="text">Change footer text color</span></a></li>
								</ul>
							</li>
							<li>
								<a href="#"><i class="fa fa-lock"></i>	<span class="text">Admins</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="users.html"><i class="fa fa-columns"></i><span class="text">Users</span></a></li>
								</ul>
							</li>
						</ul>
					</div>					
